...
class UserTexts:
    ...
    txt_exit_prompt = "Enter choice (1/2/0): "
    txt_back_option = "0. Back"
    txt_back_prompt = "Enter choice (1/2/0): "
    txt_customer_main_menu_prompt = "Enter choice: "
    txt_admin_menu_prompt = "Enter choice: "
