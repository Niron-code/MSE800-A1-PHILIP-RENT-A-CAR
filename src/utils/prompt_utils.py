...
class UserTexts:
    ...
    txt_customer_login_header = "\nCustomer Login"
    txt_change_password_header = "\nChange Password"
    txt_enter_new_password = "Enter new password: "
    txt_confirm_new_password = "Confirm new password: "
    ...
    txt_choose_username = "Choose a username: "
